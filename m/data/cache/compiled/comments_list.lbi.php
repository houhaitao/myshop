...
<div id="pagebar" class="f_r">
  <form name="selectPageForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
    ...
    <div id="pager" style="padding:1em 0" class="text-right"> <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['goods']['comment_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span> <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a> </span> 
      <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_14670000_1432645377');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_14670000_1432645377']):
?>
      <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_14670000_1432645377']; ?>" />
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
    </div>
    <?php else: ?> 
    <?php endif; ?>
  ...
  <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
    <div class="ect-padding-lr">
      ...
      <p class="ect-padding-tb code"><span>
        ...
        </span> <img class="pull-right" src="<?php echo url('public/captcha', array('rand'=>$this->_var['rand']));?>" alt="captcha" onClick="this.src='<?php echo url('public/captcha', array('rand'=>'Math.random()'));?>'"  />
        </p>
		<?php endif; ?>
      <p class="ect-padding-tb">
...
<script type="text/javascript">
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_14770000_1432645377');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_14770000_1432645377']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_14770000_1432645377']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
