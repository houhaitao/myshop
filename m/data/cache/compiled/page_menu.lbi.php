<ul class="ect-diaplay-box text-center">
  ...
  <li class="ect-box-flex"><a href="<?php echo url('category/all');?>"><i class="ect-icon ect-icon-cate"></i><?php echo $this->_var['lang']['category']; ?></a></li>
  ...
  <li class="ect-box-flex"><a href="<?php echo url('user/order_list');?>"><i class="ect-icon ect-icon-flow"></i><?php echo $this->_var['lang']['shopping_cart']; ?></a></li>
