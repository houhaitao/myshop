...
<div class="con"> 
  <header class="ect-header ect-margin-tb ect-margin-lr"> <a href="<?php echo url('category/all');?>" class="pull-left ect-icon ect-icon1 ect-icon-cate1"></a>
...
?>
  ...
  <!--logo图片div style="text-align: center;padding: 5px 0 18px;"><img src="__TPL__/images/logo.png" style="width:68%" /></div-->
